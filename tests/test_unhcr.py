...
class TestUNHCR():
    ...
    def test_generate_dataset(self, configuration, downloader):
        ...
        resources = dataset.get_resources()
        assert resources == [{'name': 'Philippines - Zamboanga Home Based IDP Re-Profiling 2016', 'description': 'Clicking "Download" leads outside HDX where you can request access to the data in csv, xlsx & dta formats', 'url': 'https://lala/index.php/auth/login/?destination=catalog/272/get-microdata', 'format': 'web app', 'resource_type': 'api', 'url_type': 'api'},
