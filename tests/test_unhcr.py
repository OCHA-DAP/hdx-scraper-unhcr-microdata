...
class TestUNHCR():
    ...
    def test_generate_dataset(self, configuration, downloader):
        ...
        assert resources == [{'name': "Socio-economic assessment of Pakistani refugees in Afghanistan's Khost and Paktika provinces 2017", 'description': 'Clicking "Download" will take you outside HDX where you can request access to this dataset in csv, xlsx, and dta formats', 'url': 'https://lala/index.php/auth/login/?destination=catalog/187/get-microdata', 'format': 'Web App', 'resource_type': 'api', 'url_type': 'api'}]
        ...
        resources = dataset.get_resources()
        assert resources == [{'name': 'Zamboanga Home Based IDP Re-Profiling 2016', 'description': 'Clicking "Download" will take you outside HDX where you can request access to this dataset in csv, xlsx, and dta formats', 'url': 'https://lala/index.php/auth/login/?destination=catalog/272/get-microdata', 'format': 'Web App', 'resource_type': 'api', 'url_type': 'api'}]
