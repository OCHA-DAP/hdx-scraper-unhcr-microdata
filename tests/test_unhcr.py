...
class TestUNHCR():
    ...
    def test_generate_dataset(self, configuration, downloader):
        ...
        assert resources == [{'name': "Socio-economic assessment of Pakistani refugees in Afghanistan's Khost and Paktika provinces 2017", 'description': 'Log in after clicking download link', 'url': 'https://lala/index.php/auth/login/?destination=catalog/187/get-microdata', 'format': 'login', 'resource_type': 'api', 'url_type': 'api'}]
        ...
        resources = dataset.get_resources()
        assert resources == [{'name': 'Zamboanga Home Based IDP Re-Profiling 2016', 'description': 'Log in after clicking download link', 'url': 'https://lala/index.php/auth/login/?destination=catalog/272/get-microdata', 'format': 'login', 'resource_type': 'api', 'url_type': 'api'}]
